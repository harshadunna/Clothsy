        ...
        {fields.map((field, i) => (
          ...
          >
            <input
              ...
              className="peer w-full px-4 pt-5 pb-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-transparent focus:outline-none focus:border-amber-400/70 transition-all duration-300"
            ...
            <label
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 text-sm text-white/40 pointer-events-none transition-all duration-200
                ...
                peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-white/50"
            >
              {field.label}
            </label>
            <motion.div
      ...
      <AnimatePresence>
        {openSnackBar && (
          ...
          >
            ...
            <motion.div
              className={`h-0.5 rounded-full mt-1.5 origin-left
                ${snackType === "error" ? "bg-red-500/60" : "bg-emerald-500/60"}`}
              initial={{ scaleX: 1 }}
              animate={{ scaleX: 0 }}
