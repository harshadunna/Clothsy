...
export default function RegisterForm({ handleNext }) {
  ...
  const floatingInputClass =
    "peer w-full px-4 pt-5 pb-2 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-transparent focus:outline-none focus:border-amber-400/70 transition-all duration-300";
