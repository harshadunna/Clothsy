...
const dummyAddresses = [
  { id: 1, firstName: "John", lastName: "Doe", streetAddress: "123 MG Road", city: "Mumbai", state: "Maharashtra", zipCode: "400001", mobile: "9876543210" },
  { id: 2, firstName: "Jane", lastName: "Doe", streetAddress: "456 Brigade Road", city: "Bangalore", state: "Karnataka", zipCode: "560001", mobile: "9123456789" },
];

const inputClass = `
  w-full px-4 py-3 rounded-xl border text-sm font-medium outline-none transition-all duration-200
            ...
            {dummyAddresses.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Deliver Here button — expands below selected card */}
                  <AnimatePresence>
                    {isSelected && (
                      <motion.div
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  type="submit"
                  className="mt-6 w-full py-4 rounded-2xl text-sm font-black tracking-wider uppercase text-white"
                  style={{
                    background: "linear-gradient(135deg, #d4832f, #c8742a)",
                    boxShadow: "0 6px 24px rgba(200,116,42,0.3)",
